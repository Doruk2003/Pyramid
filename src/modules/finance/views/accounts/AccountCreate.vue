...
async function saveAccount() {
    ...
    if (result.success) {
        toast.add({ severity: 'success', summary: 'Ba?ar?l?', detail: 'Cari hesap olu?turuldu', life: 3000 });
...
<template>
    <div class="flex flex-col gap-0">
        <div class="card p-6 min-h-32 flex flex-col gap-0">
            <h4 class="m-0 text-xl font-bold">Yeni Cari Hesap Olu?tur</h4>
            <div class="text-surface-600 dark:text-surface-400">
                <p>Cari hesap olu?turma s?ras?nda zorunlu alanlar? doldurdu?unuzdan emin olun.</p>
            </div>
        </div>
