...
function viewOrder(id: string) {
    router.push(`/purchases/orders/edit/${id}`);
}
    ...
    <div>
        <div class="card mb-4">
            <div class="flex items-center justify-between mb-0">
                <div class="m-0 text-2xl font-medium">Alış Siparişleri</div>
            </div>
            <Toolbar>
                <template #start>
                    <div class="flex gap-2">
                        <Button label="Yeni Alış Siparişi" icon="pi pi-plus" severity="secondary" @click="openNew" />
                        <Button 
        ...
        <div v-if="showFilters" class="card mb-4">
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                <div class="col-span-1">
                    <InputText v-model="filterForm.orderNumber" placeholder="Alış Sipariş No" fluid />
                </div>
                <div class="col-span-1">
        ...
        <div class="card">
            <DataTable
                ...
                emptyMessage="Kayıtlı alış siparişi bulunamadı."
            >
                <Column selectionMode="multiple" headerStyle="width: 3rem"></Column>
                <Column field="orderNumber" header="Alış Sipariş No" sortable style="min-width: 130px" />
