-- Migration: VAT Withholding (KDV Tevkifatı) Support
-- Date: 2026-09-08

-- 1. Invoices tablosuna tevkifat toplam sütunu ekle
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS withholding_total DECIMAL(18,2) DEFAULT 0;

-- 2. Invoice_lines tablosuna tevkifat oranı ve tutarı sütunları ekle
ALTER TABLE invoice_lines ADD COLUMN IF NOT EXISTS withholding_rate DECIMAL(5,2) DEFAULT 0;
ALTER TABLE invoice_lines ADD COLUMN IF NOT EXISTS withholding_amount DECIMAL(18,2) DEFAULT 0;

-- 3. save_invoice_with_lines RPC güncellemesi
...
BEGIN
    ...
    INSERT INTO invoices (
        ...
        COALESCE((p_invoice->>'withholding_total')::DECIMAL(18,2), 0),
    ...
    ON CONFLICT (id) DO UPDATE SET
        ...
        withholding_total = EXCLUDED.withholding_total,
    ...
    IF p_lines IS NOT NULL AND jsonb_typeof(p_lines) = 'array' THEN
        FOR v_line IN SELECT * FROM jsonb_array_elements(p_lines) LOOP
            INSERT INTO invoice_lines (
                ...
                COALESCE((v_line->>'withholding_rate')::DECIMAL(5,2), 0),
                COALESCE((v_line->>'withholding_amount')::DECIMAL(18,2), 0)
            );
        END LOOP;
    END IF;
END;
